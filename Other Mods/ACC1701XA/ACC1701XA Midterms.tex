...
\begin{multicols*}{4}
  ...
  \begin{itemize}
    ...
    \item \textbf{Expenses}\\
    Operating expenses: Rent, Utilities, Salaries, Advertising exp, Fees, \textbf{ECL}|
  ...
  \section{Accounting Equations}
    ...
    running business.
  \subsection{Avg Collection Period}
  ...
  \begin{itemize}
    ...
    \item $\text{TA Turnover} = \frac{Net Sales}{Avg Total Assets}$
  \end{itemize}
